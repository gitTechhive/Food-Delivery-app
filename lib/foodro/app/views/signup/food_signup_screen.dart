...
import 'package:foodro/foodro/app/controller/food_signup_controller.dart';
...
class FoodSignupScreen extends StatefulWidget {
  const FoodSignupScreen({super.key});

  @override
  FoodSignupScreenState createState() => FoodSignupScreenState();
}

class FoodSignupScreenState extends State<FoodSignupScreen> {
  final FoodSignUpController controller = Get.put(FoodSignUpController());
