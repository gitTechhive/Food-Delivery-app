...
import 'package:foodro/foodro/app/controller/food_profile_controller.dart';
...
import 'food_user_profile_widget.dart';
...
class FoodProfileScreen extends StatefulWidget {
  ...
  @override
  FoodProfileScreenState createState() => FoodProfileScreenState();
}

class FoodProfileScreenState extends State<FoodProfileScreen> {
  final FoodProfileController controller = Get.put(FoodProfileController());
  ...
  final BoxDecoration iconBorderStyle = BoxDecoration(
      ...
      border: Border.all(color: foodBorderColor, width: 1));
}
